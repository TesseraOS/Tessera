 ...
 * The slot passes layout classes (`ms-auto` right-aligns it inside the sidebar's
 * icon-link footer row, fumadocs' own docs pattern) — they MUST be merged, not dropped:
 * ignoring them is what left the toggle stranded full-width. The switch propagates
 * radially from the pressed control (ADR-0054); an explicit choice pins the theme.
 */
